...
\section{Education}
	...
	\cventry{02.2006 --\\-- 03.2009}{MSc in Cognitive Science}{}{}{University of Osnabr\"{u}ck, Germany}{Majors: \emph{Linguistics and Computational Linguistics} and \emph{Artificial Intelligence}, One Year Study Project: Analysis and Structure of Aviation Documents (ASADO), [\url{http://www.cogsci.uni-osnabrueck.de/~ASADO}]. }
	\cventry{03.2002 --\\-- 09.2002}{Semester abroad}{ILLC (Institute for Logic, Language and Computation)}{}{University of Amsterdam, The Netherlands}{}
...
\section{Research and Professional Experience}
	...
	\cventry{10.2001 --\\-- 04.2009}
        ...
        {}
        {}
        {Maintenance of computer hardware and software, user support, server administration (File Sharing, Printing, Mail, Calendaring, VCS, \ldots), configuration of a fully automated installation system for Windows, Linux and OS~X.}
...
\section{Teaching Experience}
    \cventry{2009 -- 2011\\(yearly)}{Lecture on Web corpora}{Course in text processing}{offered to students of the School of Humanities and Philosophy, of the International Master in Cognitive Science and of the Master in Human Language Technologies and Interfaces}{coordinated by Marco Baroni, University of Trento}{}
...
\cventry{05.2010}
    ...
    {}
%@InProceedings{RODRGUEZ10.431,
%  author = {Kepa Joseba Rodríguez and Francesca Delogu and Yannick Versley and Egon W. Stemle and Massimo Poesio},
...
\cvcomputer{programming}{Python, Java, JavaScript (ECMA\-Scrip), Prolog, ML}{scripting}{Bash, Perl, PHP}
\cvcomputer{scientific}{R, CQP, Matlab, OmniFind+UIMA, PDP++, Octave, Prot\'{e}g\'{e}}{design}{\LaTeX, gnuplot, Inkscape, Scribus, InDesign, Illustrator}%, OmniGraffle}
