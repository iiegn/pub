...
\section{Publications}
    ...
    %\cventry{09.2013 \\ (Submitted)}
    %    {Aivars Glaznieks, Egon~W.~Stemle, Lionel Nicolas}
    %    {\small A workflow for Building Annotated Text Corpora}
    %    {\small Third Workshop on Annotation of Corpora for Research in the Humanities (ACRH-3)}
    %    {\small}
    %    {}
    ...
    \cventry{(Accepted)} % Talk - ?proceedings
    ...
    %  Authors: Lionel Nicolas, Egon~W. Stemle, Klare Kranebitter and Verena Lyding
    %    Title: High-accuracy phrase translation acquisition
