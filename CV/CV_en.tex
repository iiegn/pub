...
\cventry{submitted}
    ...
    {In {\em Proceedings of the Tenth International Language Resources and Evaluation (LREC'10)}, Valletta, Malta}
...
\cventry{09.2009}
    ...
    {in {\em Proceedings of the 5th Web as Corpus Workshop (WAC5)}}
    {Pre-SEPLN Workshop, Donostoia-San Sebasti{\'a}n, Basque Country, Spain}
...
\cventry{09.2007}
    ...
    {in {\em Building and Exploring Web Corpora. Proceedings of the 3rd Web as Corpus Workshop, incorporating CLEANEVAL (WAC3-2007)}}
...
\cventry{07.2007}
    ...
    {in {\em Proceedings of the 22nd Conference on Artificial Intelligence (AAAI-07)}}
...
\cventry{11.2005}
  ...
  Stefaner, Egon Stemle, and Katja Wilke}
    {ASADO: The analysis and structuring of aviation documents -- final
  report}
    {Technical report, Institute of Cognitive Science at the University of
