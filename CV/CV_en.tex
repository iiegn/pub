...
%\pagebreak
\section{Publications, Talks, Conferences}
    %\cventry{}
    %    {}
    %    {\small}
    %    {\small}
    ...
    \cventry{04.2013 (Accepted)}
        {Aivars Glaznieks, Lionel Nicolas, Egon W. Stemle, and Andrea Abel}
        ...
        {\small May 16-17, 2013, Padova, Italy}
        {}

    \cventry{04.2013 (Accepted)}
        {Klara Kranebitter and Egon W. Stemle}
    ...
    \cventry{02.2013 \\ (Talk)}
        ...
        {\small Department of German Language and Literature, Faculty of
        Culture Studies, TU Dortmund University}
        {}
    ...
    %    {Egon W.~Stemle, Aivars Glaznieks, Verena Lyding, and Lionel Nicolas}
    ...
    \cventry{09.2012}
        {Lionel Nicolas, Egon W.~Stemle, and Klara Kranebitter}
