...
\section{Publications}
    ...
    %    {\small Pisa, december 9-10 2014}
    %    {}
    %


    %\cventry{06.2014 \\ (Submitted)}
    %    {Michel Genereux, Egon Stemle, Lionel Nicolas, Verena Lyding}
    %    {\small Correcting OCR errors for German in Fraktur font}
    %    {\small Semantic technologies for research in the humanities and
    %    social sciences (STRiX-2014)}
    %    {\small Gothenburg, Sweden, on November 24-25, 2014}
    %    {}
    %
...
\section{Talks}
    \cventry{09.2014 \\ (Accepted)}
        ...
        {\small Collecting language data of non-public social media profiles}
        {\small Natural Language Processing for Computer-Mediated
        Communication / Social Media (NLP4CMC)}
        {\small Pre-conference workshop at KONVENS2014, Hildesheim/Germany, October 6, 2014}
        {}
    
    \cventry{08.04.2014}
        {Alexander Onysko*, Egon W.~Stemle*}
        {\small Automated L1 identification in English learner essays and its
        implications for language transfer}
        {\small Work in Progress}
        {\small Kompetenzzentrum Sprachen, Freie Univeristät Bozen, Bozen, IT}
        {}
    ...
    \cventry{04.05.2012 \\ (Impulsreferat)}
